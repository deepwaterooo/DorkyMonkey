...
- Collaborators team project with VincentWeixun dyzhangweix https://github.com/dyzhangweix. 
- 
- suggested views: 
  - Need to fix the JSON parse bug later this week (too many things to do, just don't feel I want to work on this one yet, but will fix it later this week for sure).
