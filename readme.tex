...
\section{most recent comments}
\label{sec-1}
\begin{itemize}
\item Collaborators team project with VincentWeixun dyzhangweix \url{https://github.com/dyzhangweix}.
\item 
\item suggested views: 
\begin{itemize}
\item Need to fix the JSON parse bug later this week (too many things to do, just don't feel I want to work on this one yet, but will fix it later this week for sure).
\item A temporatory video was put at \url{https://www.youtube.com/watch?v=EcUU0I--SAs}, but supposed to change when got the last json parse works and get layout looks better.
\end{itemize}
\end{itemize}
...
\label{sec-2}
\begin{itemize}
\item \url{http://blog.csdn.net/xiaanming/article/details/10163203}
\item \url{https://github.com/dyzhangweix/QR_CodeScan}
\item get: \url{http://www.cnblogs.com/hanyonglu/archive/2012/02/19/2357842.html}
\item \url{http://www.bkjia.com/Androidjc/882604.html}
\end{itemize}
\subsection{EditText}
\label{sec-2-1}
\begin{itemize}
\item \url{http://stackoverflow.com/questions/4531396/get-value-of-a-edit-text-field}
\item bundle parcel: \url{http://chjmars.iteye.com/blog/1266256}
\item internet access: \url{http://blog.csdn.net/withiter/article/details/19908679}
\item thread pack: \url{http://stackoverflow.com/questions/3391272/how-to-use-separate-thread-to-perform-http-requests}
\end{itemize}
